				...
				<article id="<?php echo $post->ID; ?>" class="nbxco_post-wrapper">
					<div class="nbxco_inner-wrapper">
						...
						<a href="<?php the_permalink(); ?>">
							<img src="<?php echo plugin_dir_url( __FILE__ ) . '../images/nbxco_doors/co_door-'. $i .'.png'; ?>" class="nbxco_button <?php nbxco_lightbox(); ?> to-hide" value="<?php echo $post->ID; ?>" alt=""/>
						</a>
			...
			<?php while( $i_post_count <= 24 ) { ?>
				...
				<article class="nbxco_post-wrapper">
					<div class="nbxco_inner-wrapper">
						...
						<a href="#"><img src="<?php echo plugin_dir_url( __FILE__ ) . '../images/nbxco_closed_doors/co_door_e-'. $i_post_count . '.png'; ?>" class="to-hide" alt=""/></a>
						<header class="nbxco_entry-header">
...
<!--		<div class="footer">-->
			...
			<div class="nbxco_copyright"><p>Copyright 2014 <strong>Dömle Herrgård</strong></p></div>
<!--		</div>-->
